...
<html xml:lang="de" xmlns="http://www.w3.org/1999/xhtml" lang="de"><head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Jobdemands</title>
    <link rel="stylesheet" type="text/css" media="screen,print" href="css/Jobdemands/Jobdemands.css">
    ...
    <script type="text/javascript" src="js/Jobdemands/Jobdemands.js"></script>
    <link href="css/common.css" type="text/css" rel="stylesheet" />
  <link href="css/Jobdemands/JobdemandsMoz.css" type="text/css" rel="stylesheet">
</head>
        ...
        <div style="margin-left: 0px; position: relative; width: 700px; z-index: 5;" id="body_layer">
          ...
          <div style="height: 51px; left: 659px; position: absolute; top: -279px; width: 80px; z-index: 1;" class="tinyText">
            <div style="position: relative; width: 80px;">
              <img src="image/Jobdemands/shapeimage_1.png" alt="" style="height: 51px; left: 0px; position: absolute; top: 0px; width: 80px;">
            </div>
          </div>
          ...
          <div style="height: 243px; left: 0px; position: absolute; top: 1px; width: 700px; z-index: 1;" class="tinyText">
            <div style="position: relative; width: 700px;">
              <img src="image/Jobdemands/shapeimage_2.png" alt="" style="height: 243px; left: 0px; position: absolute; top: 0px; width: 700px;">
            </div>
          </div>
